...
/// A widget that displays an overlay box for content of the onboarding screen.
class OnboardingScreenStepOverlay extends StatelessWidget {
  /// Creates an [OnboardingScreenStepOverlay].
  ///
  /// The [child] parameter is required.
  const OnboardingScreenStepOverlay({
    Key? key,
    required this.child,
  }) : super(key: key);
...
/// A widget that displays content for the onboarding screen.
